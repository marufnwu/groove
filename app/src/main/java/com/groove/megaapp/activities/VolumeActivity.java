...
import com.groove.megaapp.workers.MergeAudioVideoWorker2;
import com.groove.megaapp.workers.MergeAudiosWorker;

public class VolumeActivity extends AppCompatActivity implements AnalyticsListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText(R.string.volume_label);
